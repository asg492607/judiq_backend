...
def test_simulation_plan_approval_workflow():
    ...
    approve_res = client.post("/api/v1/admin/approve-plan", headers=headers, json={
        "user_id": test_user_id
    })
    ...
    analyze_res2 = client.post("/api/v1/analyze", json=analyze_payload)
    ...
    draft_res2 = client.post("/api/v1/documents/draft-word", json={
        "user_id": test_user_id,
        "email": test_email,
