...
class CriminalTimelineEngine:
    ...
    def analyze_timelines(cls, case_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if arrest_date and not chargesheet_date:
            ...
            punishment_years = case_data.get("punishment_years", 0)

            requires_90_days = offense_type in ["302", "304", "376", "395", "409", "103", "64", "310", "316"] or punishment_years >= 10
            ...
            if days_in_custody > threshold:
                opportunities.append({
                    ...
                    "tactical_move": "IMMEDIATELY file S.167(2) CrPC / S.187 BNSS application for indefeasible Default Bail before police file the charge sheet (Sanjay Dutt v. State)."
                })
            else:
                anomalies.append({
            ...
            if limit_years > 0:
                ...
                if elapsed_years > limit_years:
                    opportunities.append({
                        ...
                        "tactical_move": "File Quashing petition or object to taking of cognizance."
                    })
    ...
    def generate_timeline(cls, case_data: Dict[str, Any]) -> List[str]:
        ...
        if case_data.get("arrest_date"):
            steps.append(f"Accused Arrested ({case_data['arrest_date']}): Remand proceedings initiated u/s 167 CrPC / S.187 BNSS.")
    ...
    def check_criminal_limitation(cls, case_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        no_limitation_crimes = ["420", "318", "302", "103", "376", "64", "392", "309", "395", "310", "NDPS"]
        ...
        limit_years = 1 if offense_type in one_year_limit_crimes else 3
