...
// =============================================================================
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '  font-size: 22px; line-height: 1; color: var(--text-muted, #64748b);',
            '  padding: 4px 8px; border-radius: 8px;',
            '  transition: background 150ms, color 150ms;',
            '}',
            '.jq-modal__close:hover { background: rgba(0,0,0,0.06); color: var(--text-primary, #0f172a); }',
            /* Title */
            '.jq-modal__title {',
            '  font-size: 1.25rem; font-weight: 750;',
            '  color: var(--text-primary, #0f172a); margin: 0 0 16px;',
            '  display: flex; align-items: center; gap: 8px;',
            '}',
            /* Body */
            '.jq-modal__body {',
            '  flex: 1; overflow-y: auto;',
            '  font-size: 0.935rem; line-height: 1.65;',
            ...
            '.jq-btn--primary { background: linear-gradient(135deg, #4f46e5, #3730a3); color: #fff; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.35); }',
            '.jq-btn--primary:hover { box-shadow: 0 6px 16px rgba(79, 70, 229, 0.45); }',
            '.jq-btn--secondary { background: var(--bg-elevated, #f1f5f9); color: var(--text-secondary, #475569); border: 1px solid var(--border-color, rgba(0,0,0,0.1)); }',
            '.jq-btn--secondary:hover { background: var(--border-color, #e2e8f0); color: var(--text-primary, #0f172a); }',
            '.jq-btn--danger { background: #dc2626; color: #fff; }',
            /* Disclaimer-specific */
            '.jq-modal--disclaimer .jq-modal { max-width: 620px; }',
            '.jq-modal--disclaimer .jq-modal__body {',
            '  max-height: 52vh; border: 1px solid var(--border-color, rgba(0,0,0,0.08));',
    ...
    onDOMReady(function () {
        injectStyles();
        wireDataAttributes();
        // Disclaimer consent is handled unobtrusively in the case launch and signup flows
        // rather than interrupting initial visitor landing view.
    });
